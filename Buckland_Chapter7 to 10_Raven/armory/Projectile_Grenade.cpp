...
//-------------------------- ctor ---------------------------------------------
//-----------------------------------------------------------------------------
Projectile_Grenade::Projectile_Grenade(Raven_Bot* shooter, Vector2D target) :
...
//------------------------------ Update ---------------------------------------
//-----------------------------------------------------------------------------
void Projectile_Grenade::Update()
{
	if (!m_bImpacted)
	{
...
void Projectile_Grenade::TestForImpact()
{
...
//-----------------------------------------------------------------------------
void Projectile_Grenade::InflictDamageOnBotsWithinBlastRadius()
{
...
//-------------------------- Render -------------------------------------------
//-----------------------------------------------------------------------------
void Projectile_Grenade::Render()
{
